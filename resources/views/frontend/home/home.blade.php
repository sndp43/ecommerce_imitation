...
{{-- 
    ...
    <!--============================
        SINGLE BANNER START
    ==============================-->
    @include('frontend.home.sections.banner-statistics')
    <!--============================
        SINGLE BANNER END
    ==============================-->
    ...
    <!--============================
        OUR PRODUTS START
    ==============================-->
    @include('frontend.home.sections.our-products')
    <!--============================
        OUR PRODUTS END
    ==============================-->

     <!--============================
        product-banner-statistics.blade START
    ==============================-->
    @include('frontend.home.sections.product-banner-statistics')
    <!--============================
        product-banner-statistics.blade END
    ==============================-->
